...
class QuickTellerController extends BaseController
{
  ...
  **/
   ...
   ** path="/api/v1/user/quickteller/submit-bill-payment",
    ...
    *              @OA\Property( property="customerEmail", type="string", description="It should be hidden"),
    *              @OA\Property( property="customerMobile", type="string", description="It should be hidden"),
